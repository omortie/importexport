create table artists (id INTEGER primary key AUTOINCREMENT, artist varchar(40), albumcount int);
...
create table albums (albumid INTEGER primary key AUTOINCREMENT, title varchar(50), artistid int, year int);
